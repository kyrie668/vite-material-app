...
export default class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.errorInfo) {
      return (
        <>
          <ErrorWrapper className="main_wrapper">
            <div className="main">
        ...
        C86.34,11.918,137.664-5.445,189.928,1.502l-3.95,29.738C143.041,25.54,100.895,39.789,70.343,70.343z"
          ...
          <h3 style={{ marginTop: "3rem",textAlign:'center' }}>Excuse me. Please wait for our team to fix it.</h3>
        </>
        // <div>
        ...
        //     <div>Excuse me.Please wait for our team to fix it.</div>
        //   </details>
        // </div>
      );
    }
